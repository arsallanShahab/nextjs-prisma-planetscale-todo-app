    ...
    >
      <div className="flex items-center gap-5 justify-start pr-2.5">
        <Checkbox
          checked={isCompleted}
          id={todo?.id}
          className="w-5 h-5 bg-amethyst-300 rounded-md border-none data-[state=checked]:text-amethyst-100 dark:data-[state=checked]:text-amethyst-300 data-[state=checked]:bg-amethyst-600 dark:bg-zinc-700 dark:data-[state=checked]:bg-amethyst-700 active:scale-110"
          onClick={updateTodo}
        />
      ...
      <div className="flex items-center">
        <button
          ...
          className={cn(
            "w-10 h-10 flex items-center justify-center rounded-xl dark:bg-zinc-700 dark:border-zinc-800 bg-white border border-amethyst-100"
          )}
        >
          <BadgeX
            className={cn(
